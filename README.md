MindEdge - Backend API
This repository contains the backend infrastructure for MindEdge, built with a focus on performance, security, and scalable architecture.
...
Database: SQL Server (Remote Hosting via Monster ASP)
...
Visual Studio 2026: (Recommended) Include .NET SDK and SQL Server support workloads.

VS Code: Install the C# Dev Kit extension.

2. Configuration
Before launching, ensure the following credentials are set in your environment or appsettings.json:
...
Password: yS?5#2Ao4e@J

SMTP / App Password:
Required for email services to function correctly:
...
*   **Zeina Mohamad** 
    *   GitHub Account: [zeina-m36](https://github.com/zeina-m36)
